        ...
        wrapper.innerHTML += `
            ...
            <td style="font-family: Imaki;margin: 0 auto">${user.id}</td>
                ...
                <td>
                    ...
                    <button id="botonEditar"onclick="editarUser('${user.id}','${user.nombre}','${user.contra}', '${user.apellido1}', '${user.apellido2}', '${user.direccion}', '${user.pais}')">
...
function editarUser(id,nombre,contra, apellido1, apellido2, direccion, pais,usertype) {
    // Almacenar los datos del usuario que se está editando
    userEditando = { id,nombre, apellido1, apellido2, direccion, pais,usertype };
